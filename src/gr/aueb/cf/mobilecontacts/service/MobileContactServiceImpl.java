...
public class MobileContactServiceImpl implements IMobileContactService {
    ...
    public MobileContact insertMobileContact(MobileContactInsertDTO dto) throws PhoneNumberAlreadyExistsException {
        ...
        try {
            if (dao.phoneNumberExists(dto.getPhoneNumber())) {
                throw new PhoneNumberAlreadyExistsException("Contact with number " + dto.getPhoneNumber() + " already exist.");
            }
    ...
    public MobileContact getContactById(Long id) throws ContactNotFoundException {
        ...
        try {
            ...
            System.err.println("MobileContactServiceImpl Logger: Contact with id: " + id + "was not found to get returned.");
            throw e;
        }
    }

    @Override
    public List<MobileContact> getAllContact() {
        return dao.getAll();
    }
    ...
    public MobileContact getContactByPhoneNumber(String phoneNumber) throws ContactNotFoundException {
        ...
        try {
            ...
            System.err.println("MobileContactServiceImpl Logger: Contact with phone number: " + phoneNumber + "was not found to get returned.");
            throw e;
        }
    }
